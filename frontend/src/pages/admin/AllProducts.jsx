...
import './AllProducts.css'; // ✅ External CSS for small screen responsiveness
...
const AllProducts = () => {
  ...
  return (
    <div className="container mx-[9rem] all-products-container">
        ...
        <div className="p-3 w-full">
          ...
          <div className="flex flex-wrap justify-around items-center">
            {products.map((product) => (
              <div key={product._id} className="block mb-4 overflow-hidden product-card">
                <div className="flex product-inner">
                  <img
                    src={`${import.meta.env.VITE_API_BASE}${product.image}`}
                    alt={product.name}
                    className="w-[10rem] object-cover product-image"
                  />
                  <div className="p-4 flex flex-col justify-around">
                    <div className="flex justify-between product-header">
                    ...
                    <p className="text-gray-400 xl:w-[30rem] md:w-[20rem] sm:w-[10rem] text-sm mb-4 product-description">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <p className="ml-4 font-bold">Rs. {product?.price}</p>
                    </div>
                  </div>
                </div>
              </div>
