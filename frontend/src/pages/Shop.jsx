          ...
          {categories?.map((c)=>(
            <div key={c._id} className="mb-2">
              <div className="flex items-center mr-4">
                <input type="checkbox" id="red-checkbox" onChange={e=> handleCheck(e.target.value, c._id)} className="w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 rounded focus:ring-pink-500 dark: focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
  ...
  <React.Fragment key={brand}>
    <div className="flex items-center mr-4 mb-5">
      <input
        ...
        className="w-4 h-4 ..."
      />
      <label htmlFor="pink-radio" className="ml-2 ...">
        {brand}
      </label>
    </div>
  </React.Fragment>
