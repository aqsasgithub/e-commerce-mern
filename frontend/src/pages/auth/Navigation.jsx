...
<div
  style={{ zIndex: 9999 }}
  className="group fixed top-0 left-0 h-screen w-[4%] hover:w-[15%] bg-black text-white flex flex-col justify-between p-4 transition-all duration-300 overflow-x-visible overflow-y-auto"
